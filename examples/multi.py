...
if pm.comm.rank == 0:
    ...
    ax.plot(r1.power['k'], r2.power['power'] / r1.power['power'], label='tot / core')
    ax.plot(r1.power['k'], r2_b.power['power'] / r1.power['power'], label='b / core')
    ax.plot(r1.power['k'], r2_cdm.power['power'] / r1.power['power'], label='cdm/ core')
    ax.plot(r1.power['k'], r2_ncdm.power['power'] / r1.power['power'], label='ncdm / core')
    ax.legend()
    ax.set_xscale('log')
